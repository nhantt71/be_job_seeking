...
public class ApiCategoryController {
    ...
    @GetMapping("/get-cate-by-id/{id}")
    public ResponseEntity<Category> getCateById(@PathVariable("id") Long id){
        return new ResponseEntity<>(this.cs.getCateById(id), HttpStatus.OK);
    }
